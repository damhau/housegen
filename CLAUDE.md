...
kit/       housekit: runtime.js (scene boot, views, effects, headless hooks), house.js (parametric components),
           template/ (starting scene), assets/textures (CC0 PBR sets), test/ (Node tests). three.js and ez-tree
           (@dgreenheck/ez-tree, the tree generator behind leafTree/leafBush) vendored via npm in kit/node_modules,
           served at /kit/vendor/{three,ez-tree}; house.js falls back to its procedural trees without ez-tree.
